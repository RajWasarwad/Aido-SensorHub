...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  if(hi2c->Instance==I2C1)
  {
    ...
    PB7     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = BME688_SCL_Pin|BME688_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(BME688_SCL_GPIO_Port, BME688_SCL_Pin);

    HAL_GPIO_DeInit(BME688_SDA_GPIO_Port, BME688_SDA_Pin);
